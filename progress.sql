...
create or replace function newtask(par_id int8, par_name text, par_description text, par_done boolean) returns text as
$$
  declare
    loc_id text;
    loc_res text;
...
--select newtask(0000, 'Bea Pascubillo','Janitor 1', false);
--select newtask(0001, 'Lyn Albacete','Janitor 2', false);
--select newtask(0010, 'Mikee Villanueva', 'Janitor 3', false);
--select newtask(0011, 'Seanne Canoy', 'Janitor 4', false);
--select newtask(0100, 'Joanna Ompoc', 'Janitor 5',false);
